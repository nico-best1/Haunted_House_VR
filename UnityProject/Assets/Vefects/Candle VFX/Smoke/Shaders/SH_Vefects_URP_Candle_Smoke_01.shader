...
Shader "Vefects/SH_Vefects_URP_Candle_Smoke_01"
{
	Properties
	{
		...
		_VerticalDistortionFalloff("Vertical Distortion Falloff", Float) = 0
		_VerticalOpacityPosition("Vertical Opacity Position", Float) = 1
		_VerticalOpacityFalloff("Vertical Opacity Falloff", Float) = 0
	...
	SubShader
	{
		Tags{ "RenderType" = "Transparent"  "Queue" = "Transparent+0" "IsEmissive" = "false"  }
		Cull [_Cull]
		ZWrite [_ZWrite]
		ZTest [_ZTest]
		Blend [_Src] [_Dst]
